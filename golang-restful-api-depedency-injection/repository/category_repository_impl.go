...
// Function untuk membuat object (mirip constructor), karena di golang tidak ada konsep OOP
// Sebenernya ini balikkanya interface, tapi karena kita belajar Depedensi Injection maka diganti ke Struct
